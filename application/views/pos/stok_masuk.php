                            ...
                            <div class="box-bg-grey">
                                <table class="mb-0 full-width">
                                    <tbody class="nowraping">
                                        <tr>
                                            <td width="25%">No Faktur <span class="text-danger">*</span></td>
                                            <td width="2%">&nbsp;:&nbsp;</td>
                                            <td width="75%"><input type="text" class="form-control input-full sm-height" name="nofaktur" id="nofaktur" placeholder="No Faktur" required></td>
                                        </tr>
                                        <tr>
                                            <td>Supplier <span class="text-danger">*</span></td>
                                            <td>&nbsp;:&nbsp;</td>
                                            <td><input type="text" class="form-control input-full sm-height" name="supplier" id="supplier" placeholder="Supplier" required></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal <span class="text-danger">*</span></td>
                                            <td>&nbsp;:&nbsp;</td>
                                            <td><input type="text" class="form-control input-full pointer sm-height tgl" id="tgl_masuk" name="tgl_masuk" style="background: white !important; opacity: 1 !important;" value="<?= date("d-m-Y") ?>" readonly required></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <div class="modal-content">
            <form id="form-alasan-hapus" novalidate="novalidate" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body text-center">
                    <h5 class="modal-title py-3" style="color:rgba(0,0,0,.65);font-weight:600;font-size:27px;line-height:normal;">Hapus Stok Masuk</h5>
                    <div class="" style="width:100% !important; padding:15px; border-radius:4px; font-size:13px; background-color:#f7d9d9;">
                        <span>Apakah anda yakin ingin menghapus data stok masuk dengan nota</span><br>
                    ...
                    <div class="py-3">
                        <input type="hidden" name="id_stok_masuk">

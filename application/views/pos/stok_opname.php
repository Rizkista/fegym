<div class="page-inner">
    ...
    <div id="show-stok">
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatable-stok-opname" class="table-responsive display table table-striped table-hover" >
                    <thead>
                        <tr>
                            <th style="width:5%;">No</th>
                            <th style="width:15%;">Tanggal</th>
                            <th style="width:10%;">No.Opname</th>
                                ...
                                <table class="mb-0 full-width">
                                    <tbody class="nowraping">
                                        <tr>
                                            ...
                                            <td width="2%">&nbsp;:&nbsp;</td>
                                            <td width="75%"><input type="text" class="form-control input-full pointer sm-height tgl" id="tgl_opname" name="tgl_opname" style="background: white !important; opacity: 1 !important;" value="<?= date("d-m-Y") ?>" readonly required></td>
                                        </tr>
                                        <tr valign="top">
        ...
        <div class="modal-content">
            <form id="form-alasan-hapus" novalidate="novalidate" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body text-center">
                    <h5 class="modal-title py-3" style="color:rgba(0,0,0,.65);font-weight:600;font-size:27px;line-height:normal;">Hapus Stok Opname</h5>
                    <div class="" style="width:100% !important; padding:15px; border-radius:4px; font-size:13px; background-color:#f7d9d9;">
                        <span>Apakah anda yakin ingin menghapus data stok opname dengan nota</span><br>
                    ...
                    <div class="py-3">
                        <input type="hidden" name="id_stok_opname">
                ...
                <div id="cetak-nota">
                    ...
                    <div class="nota">
                        <table class="w100 mb5">
                            <tr>
                                <th class="left-text">Stok Opname</th>

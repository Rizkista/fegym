<div class="page-inner">
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="tabel-pendapatan-paket">
                    <thead>
                        <tr>
                            ...
                            <th class="nowraping" width="12%">Anggota</th>
                            <th class="nowraping" width="12%">Paket</th>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table display table-striped table-hover no-footer dataTable" id="summary-pendapatan-paket">
                    <thead>
                        <tr>
